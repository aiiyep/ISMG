...
SECRET_KEY = 'django-insecure-=3(0aix6vj1_z1=-f0gjksyw)$1s27jpule(kjhya7^&)86y@l'
...
INSTALLED_APPS = [
    ...
    'home.apps.HomeConfig',  # ✅ Deve estar ASSIM (não apenas 'home')
]
...
# Configuração de e-mail (opcional - para envio de confirmações)
...
DEFAULT_FROM_EMAIL = 'contato@mulheresdosulglobal.com'
